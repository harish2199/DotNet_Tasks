namespace Collections_CustomerDetails_Assignment
{
    internal class Program
    {
        ...
        class Details { 
            ...
            public Details()
            {
                ...
                {
                    //new Customer { Id = CustomerId++, FirstName = "Harish", LastName = "Dasu", Email = "harish@gmail.com", Age = 23, PhoneNumber = "9381963388", City = "JRG"},
                    //new Customer { Id = CustomerId++, FirstName = "Nithin", LastName = "Dhara", Email = "nithin@gmail.com", Age = 23, PhoneNumber = "9481967383", City = "NTA"}
                };
            }
